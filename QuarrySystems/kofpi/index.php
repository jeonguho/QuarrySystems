...
<html>
  <head>
    ...
    <style type="text/css">
	  ...
	  a.button { color: #ffffff; background-color: #187f40; width: 160px; }
	  a.button:hover { color: #ffffff; background-color: #4aa14e; }
	  .block-box { border: 2px solid #187f40; margin-top: 56px; border-radius: 5px; }	
	  .block-title { font-size: 24px; color: #fff; font-weight: bold; text-align:center; padding: 10px; background-color: #187f40;}
  ...
  <body>
    <div class="center">
		...
		<div class="declaration">
			<a href="submit.php?loc=<?=$loc?>" target="_blank" class="button">신고하기</a>
		</div>
		<div class="request">
			문의사항: 기획혁신본부 운영지원실 정선경 책임 (T : 02-6393-2542)
		</div>
	</div>
  </body>
</html>
